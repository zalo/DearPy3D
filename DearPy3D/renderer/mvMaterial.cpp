...
mvMaterial 
mvCreateMaterial(mvMaterialData materialData, const char* vertexShader, const char* pixelShader)
{
    mvMaterial material{};
...
mvMaterial 
mvCreateObjMaterial(mvMaterialData materialData, mvObjMaterial objMaterial, const char* vertexShader, const char* pixelShader, const std::string& path)
{
    mvMaterial material{};
    material.descriptorSets = new VkDescriptorSet[GContext->graphics.swapChainImages.size()];
    material.pipeline.vertexShader = mvCreateShader(vertexShader);
    material.pipeline.fragShader = mvCreateShader(pixelShader);
    //material.texture = mvCreateTexture("../../Resources/brickwall.jpg");
    material.texture = mvCreateTexture(path + objMaterial.diffuseMap);
    material.sampler = mvCreateSampler();
...
void 
mvCleanupMaterial(mvMaterial& material)
{
